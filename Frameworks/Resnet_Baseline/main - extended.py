...
class optuna_run:
    ...
    def __call__( 
        ...
        factor_80_100 = trial.suggest_float("factor_80_100", 0.1, 2.0)
        factor_60_80  = trial.suggest_float("factor_60_80", 0.1, 2.0)
        factor_40_60  = trial.suggest_float("factor_40_60", 0.1, 2.0)
        factor_20_40  = trial.suggest_float("factor_20_40", 0.1, 2.0)
        factor_0_20   = trial.suggest_float("factor_0_20", 0.1, 2.0)
        
        # 2) Construct your score_card dict with these trial-suggested values
        score_card = {
            "80-100": factor_80_100,
            "60-80": factor_60_80,
            "40-60": factor_40_60,
            "20-40": factor_20_40,
            "0-20":  factor_0_20
    ...
    if (use_optuna is True): 
        ...
        for training_type in training_types:
            ...
            study = optuna.create_study( 
                                            study_name = "TuneScoreCard_{}_{}".format(model_name, training_type), 
        ...
        optimizer = torch.optim.Adagrad(params, lr = 0.001)
        score_card = {
            "80-100": 0.3081056553632504,
            "60-80": 0.11100381946611293,
            "40-60": 0.3777473406561581,
            "20-40": 0.10506212508337331,
            "0-20":  0.24105469904741056
        }
        results = start_training(
                                score_card = score_card ,
                                training_type = "train_val_basic", 
                                config = config, 
                                model = model, 
                                optimizer = optimizer, 
                                DEVICE = DEVICE, 
